...
export const getAnalyticsConfig = () => {
  if (process.env.NEXT_PUBLIC_PLAUSIBLE_SCRIPT_BASE_URL) {
    console.warn(
      'NEXT_PUBLIC_PLAUSIBLE_SCRIPT_BASE_URL is deprecated. Please use PLAUSIBLE_SCRIPT_BASE_URL instead. We will remove it in DeusGPT Chat 1.0',
    );
  }
  ...
  if (process.env.NEXT_PUBLIC_POSTHOG_HOST) {
    console.warn(
      'NEXT_PUBLIC_POSTHOG_HOST is deprecated. Please use POSTHOG_HOST instead. We will remove it in DeusGPT Chat 1.0',
    );
  }

  if (process.env.NEXT_PUBLIC_UMAMI_SCRIPT_URL) {
    console.warn(
      'NEXT_PUBLIC_UMAMI_SCRIPT_URL is deprecated. Please use UMAMI_SCRIPT_URL instead. We will remove it in DeusGPT Chat 1.0',
    );
  }
