...
export class Meta {
  public generate({
    description = 'DeusGPT Chat offers you the best ChatGPT, OLLaMA, Gemini, Claude WebUI user experience',
    title,
    image = '/og/cover.png',
    url,
    type = 'website',
    ...
    const siteTitle = title.includes('DeusGPT Chat') ? title : title + ' · DeusGPT Chat';
    return {
