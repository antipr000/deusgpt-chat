---
title: >-
  Troubleshooting `OPENAI_PROXY_URL` in DeusGPT Chat Configuration for Empty Response

description: >-
  Learn how to troubleshoot and resolve the issue of receiving an empty response after configuring the DeusGPT Chat `OPENAI_PROXY_URL` environment variable.
