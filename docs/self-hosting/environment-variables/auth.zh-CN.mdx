---
title: DeusGPT Chat 身份验证服务设置
description: 了解如何配置 DeusGPT Chat 的身份验证服务环境变量。
tags:
  - DeusGPT Chat
  - 身份验证服务
  - 单点登录
...
DeusGPT Chat 在部署时提供了完善的身份验证服务能力，以下是相关的环境变量，你可以使用这些环境变量轻松定义需要在 DeusGPT Chat 中开启的身份验证服务。
