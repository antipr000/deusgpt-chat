---
title: Integrating Analytics in DeusGPT Chat
description: >-
  Learn how to configure environment variables for Vercel Analytics, Google Analytics, PostHog Analytics, and Umami Analytics in DeusGPT Chat for data collection and analysis.
...
We have integrated several free/open-source data analytics services in DeusGPT Chat for collecting user usage data. Here are environment variables that you can use.
