---
title: DeusGPT Chat Model Service Providers - Environment Variables and Configuration
description: >-
...
When deploying DeusGPT Chat, a rich set of environment variables related to model service providers is provided, allowing you to easily define the model service providers to be enabled in DeusGPT Chat.
