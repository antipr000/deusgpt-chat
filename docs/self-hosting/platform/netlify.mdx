---
title: Deploy DeusGPT Chat with Netlify - Step-by-Step Guide
description: >-
  Learn how to deploy DeusGPT Chat on Netlify with detailed instructions on forking the repository, preparing your OpenAI API Key, importing to Netlify workspace, configuring site name and environment variables, and monitoring deployment progress.
...
# Deploy DeusGPT Chat with Netlify

If you want to deploy DeusGPT Chat on Netlify, you can follow these steps:

## Deploy DeusGPT Chat with Netlify

<Steps>
  ### Fork the DeusGPT Chat Repository

Click the Fork button to fork the DeusGPT Chat repository to your GitHub account.
...
Next, select the DeusGPT Chat project:

<Image
  alt={'Select the DeusGPT Chat github project'}
  height={228}
  inStep
...
<Image
  alt={'Configure DeusGPT Chat site name'}
  height={712}
  inStep
...
<Image
  alt={'Add DeusGPT Chat site environment variables'}
  height={537}
  inStep
...
<Callout type={'tip'}>
  For a complete list of environment variables supported by DeusGPT Chat, please refer to the [📘
...
Upon entering the deployment details, you will see the following interface, indicating that your DeusGPT Chat is currently being deployed. Simply wait for the deployment to complete.

<Image
  alt={'DeusGPT Chat deployment in progress'}
  height={325}
  inStep
...
If your Deploy Log in the interface looks like the following, it means your DeusGPT Chat has been successfully deployed.
...
At this point, you can click on "Open production deploy" to access your DeusGPT Chat site.

  <Image alt={'Access Your DeusGPT Chat Site'} height={527} inStep src={'https://github.com/lobehub/lobe-chat/assets/28616219/b04723eb-64ad-4028-a901-dc4e4ee2d0c1'} />
</Steps>
