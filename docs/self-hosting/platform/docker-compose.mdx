---
title: Deploy DeusGPT Chat with Docker Compose
description: >-
  Learn how to deploy the DeusGPT Chat service using Docker Compose. Follow step-by-step instructions to install Docker, run the deployment command, and set up automatic updates.
...
We provide a [Docker image][docker-release-link] for deploying the DeusGPT Chat service on your private device.
