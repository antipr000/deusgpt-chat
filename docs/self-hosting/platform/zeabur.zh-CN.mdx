---
title: 在 Zeabur 上部署 DeusGPT Chat
description: 按照指南准备 OpenAI API Key 并点击按钮进行部署。在部署完成后，即可开始使用 DeusGPT Chat 并选择是否绑定自定义域名。
tags:
  - Zeabur
  - DeusGPT Chat
  - OpenAI API Key
...
如果想在 Zeabur 上部署 DeusGPT Chat，可以按照以下步骤进行操作：
