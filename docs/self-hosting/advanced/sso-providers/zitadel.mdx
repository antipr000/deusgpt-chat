---
title: Configure ZITADEL Authentication Service for DeusGPT Chat
description: >-
  Learn how to configure ZITADEL Authentication Service for DeusGPT Chat deployment, including creating ZITADEL applications, setting up environment variables, and enabling single sign-on (SSO).

tags:
  - ZITADEL Authentication
  - DeusGPT Chat Deployment
  - Single Sign-On (SSO)
...
- Replace `http(s)://your-domain` with the actual URL that DeusGPT Chat is deployed to.
  </Callout>
...
<Callout>
  After successful deployment, users will be able to authenticate and use DeusGPT Chat using
  existing users configured in ZITADEL.
</Callout>
