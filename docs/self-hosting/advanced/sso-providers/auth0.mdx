---
title: Configure Auth0 Identity Verification Service for DeusGPT Chat
description: >-
  Learn how to configure Auth0 Identity Verification Service for DeusGPT Chat for your organization, including creating applications, adding users, and configuring environment variables.
...
Click on the "Users Management" in the left navigation bar to enter the user management interface, where you can create users for your organization to log in to DeusGPT Chat.
...
When deploying DeusGPT Chat, you need to configure the following environment variables:

| Environment Variable | Type | Description |
| --- | --- | --- |
| `ENABLE_OAUTH_SSO` | Required | Enable single sign-on (SSO) for DeusGPT Chat. Set to `1` to enable single sign-on. |
...
<Callout>
  After successful deployment, users will be able to authenticate and use DeusGPT Chat using the
  users configured in Auth0.
</Callout>
...
<Callout type={'warning'}>
  ...
  DeusGPT Chat being abused by external users.
</Callout>
