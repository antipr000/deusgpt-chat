---
title: Configuration of Microsoft Entra ID Authentication Service for DeusGPT Chat
description: >-
  Learn how to configure Microsoft Entra ID Authentication Service for DeusGPT Chat, create applications, add users, and set up environment variables for seamless integration.
...
Go back to the "Microsoft Entra ID" interface, enter "Users", click on "New user", fill in the user information, and click on "Create" to create a user for using DeusGPT Chat.
...
<Callout>
  ...
  users configured in Microsoft Entra ID.
</Callout>
