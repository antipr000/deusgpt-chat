---
title: Configuring Authentik Authentication Service for DeusGPT Chat
description: >-
  Learn how to configure Authentik for Single Sign-On (SSO) for DeusGPT Chat, including creating an application provider, setting environment variables, and deployment instructions.

tags:
  - Authentik Configuration
  - Single Sign-On (SSO)
  - DeusGPT Chat Authentication
...
<Callout type={'info'}>
  After a successful deployment, users will be able to use DeusGPT Chat by authenticating with the
  users configured in Authentik.
</Callout>
