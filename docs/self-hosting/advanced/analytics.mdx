---
title: Integrating Data Analytics Services in DeusGPT Chat for User Usage Analysis
description: >-
  Learn how to integrate free/open-source data analytics services in DeusGPT Chat to collect user usage data efficiently.
...
To better help analyze the usage of DeusGPT Chat users, we have integrated several free/open-source data analytics services in DeusGPT Chat for collecting user usage data, which you can enable as needed.
