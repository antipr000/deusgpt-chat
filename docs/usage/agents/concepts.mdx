---
title: Improving User Interaction Efficiency with Agents in DeusGPT Chat
description: >-
  Discover how DeusGPT Chat's innovative approach with Agents enhances user experience by providing dedicated functional modules for efficient task handling and quick access to historical conversations.
...
Therefore, in DeusGPT Chat, we have introduced the concept of **Agents**. An agent is a complete functional module, each with its own responsibilities and tasks. Assistants can help you handle various tasks and provide professional advice and guidance.
