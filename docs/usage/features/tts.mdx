---
title: DeusGPT Chat support Speech Synthesis and Recognition (TTS & STT)
description: >-
  Experience seamless Text-to-Speech (TTS) and Speech-to-Text (STT) technologies in DeusGPT Chat. Choose from a variety of high-quality voices for personalized communication. Learn more about Lobe TTS toolkit @lobehub/tts.
...
<Callout type={'info'}>
  During the implementation of the TTS feature in DeusGPT Chat, we found that there was no good
  frontend TTS library on the market, which resulted in a lot of effort being spent on
  implementation, including data conversion, audio progress management, and speech visualization.
  Adhering to the "Community First" concept, we have polished and open-sourced this implementation,
  hoping to help community developers who want to implement TTS.
</Callout>
