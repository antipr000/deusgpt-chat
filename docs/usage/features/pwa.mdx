---
title: DeusGPT Chat support Progressive Web Apps (PWA)
description: >-
  Discover how DeusGPT Chat utilizes Progressive Web App (PWA) technology to provide a seamless and near-native app experience on both desktop and mobile devices. Learn how to install DeusGPT Chat as a desktop app for enhanced convenience.
...
<Callout type={'tip'}>
  The default installed DeusGPT Chat PWA icon has a black background, you can use <kbd>cmd</kbd> +{' '}
